...
void account_init(account_t *account, int id, const char *name,
...
void book_init(book_t *book, int id, const char *title, const char *author,
...
void loan_init(loan_t *loan, int id, const timestamp_t *starting_time,
