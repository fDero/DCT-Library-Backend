...
protected:
    static void SetUpTestSuite()
    {
        ...
        timestamp_t *timestamp_book_2 =
            string_to_timestamp("1949-06-08 00:00:00");
        timestamp_t *timestamp_book_3 =
            string_to_timestamp("1980-11-01 00:00:00");
        timestamp_t *timestamp_book_4 =
            string_to_timestamp("2014-05-15 00:00:00");
        timestamp_t *timestamp_book_5 =
            string_to_timestamp("1954-07-29 00:00:00");
        ...
        loan_init(db_loan_1, 1, timestamp_loan_1_st, timestamp_loan_1_et, 1,
                  1);
        loan_init(db_loan_2, 2, timestamp_loan_2_st, timestamp_loan_2_et, 2,
                  2);
        loan_init(db_loan_3, 3, timestamp_loan_3_st, timestamp_loan_3_et, 3,
                  4);
        loan_init(db_loan_4, 4, timestamp_loan_4_st, timestamp_loan_4_et, 3,
                  2);
        loan_init(db_loan_5, 5, timestamp_loan_5_st, timestamp_loan_5_et, 4,
                  5);
        loan_init(db_loan_6, 6, timestamp_loan_6_st, timestamp_loan_6_et, 5,
                  1);
