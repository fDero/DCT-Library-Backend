...
protected:
    static void SetUpTestSuite() {
        ...
        book_init(db_book_1, 1, "Harry Potter", "J.K.Rowling", "Bloomsbury", "Fantasy,Young adult literature,Adventure fiction", &timestamp_book_1, 10);
        book_init(db_book_2, 2, "1984", "G.Orwell", "Secker & Warburg", "Fiction,Science fiction,Mystery", &timestamp_book_2, 6);
        book_init(db_book_3, 3, "Karamazov Brothers", "F.Dostoevskij", "The Russian Messenger", "Fiction,Novel,Mystery,Historical fiction,Literary fiction", &timestamp_book_3, 4);
        book_init(db_book_4, 4, "Programming, Principles and Practices Using C++", "Bjarne Stroustrup", "Pearson", "Education", &timestamp_book_4, 3);
        book_init(db_book_5, 5, "The Lord of the Rings", "John Ronald Reuel Tolkien", "George Allen and Unwin (UK) Houghton Mifflin (US)", "Fantasy fiction,Adventure fiction", &timestamp_book_5, 2);
        book_init(db_book_6, 6, "The Hunger Games", "Suzanne Collins", "Scholastic Press", "Science fiction,Adventure fiction,Young adult literature", &timestamp_book_6, 7);
