...
protected:
    ...
    static void SetUpTestSuite() {
        ...
        account_init(db_account_1, 1, "John", "Smith", "john.smith@example.com", "ABCDEFGH");
        account_init(db_account_2, 2, "Emma", "Johnson", "emma.johnson@example.com", "ABCDEFGH");
        account_init(db_account_3, 3, "William", "Brown", "william.brown@example.com", "ABCDEFGH");
        account_init(db_account_4, 4, "Olivia", "Williams", "olivia.williams@example.com", "ABCDEFGH");
        account_init(db_account_5, 5, "James", "Jones", "james.jones@example.com", "ABCDEFGH");
        account_init(db_account_6, 6, "Sophia", "Davis", "sophia.davis@example.com", "ABCDEFGH");
        ...
        book_init(
            db_book_1, 1, "Harry Potter", "J.K. Rowling", "Bloomsbury",
            "Fantasy,Young adult literature,Adventure fiction",
            timestamp_book_1, 10
        );

        book_init(
            db_book_2, 2, "1984", "G. Orwell", "Secker & Warburg",
            "Fiction,Science fiction,Mystery", timestamp_book_2, 6
        );

        book_init(
            db_book_3, 3, "Karamazov Brothers", "F. Dostoevskij", "The Russian Messenger",
            "Fiction,Novel,Mystery,Historical fiction,Literary fiction", timestamp_book_3, 4
        );

        book_init(
            db_book_4, 4, "Programming, Principles and Practices Using C++",
            "Bjarne Stroustrup", "Pearson", "Education", timestamp_book_4, 3
        );

        book_init(
            db_book_5, 5, "The Lord of the Rings", "John Ronald Reuel Tolkien",
            "George Allen and Unwin (UK) Houghton Mifflin (US)",
            "Fantasy fiction,Adventure fiction", timestamp_book_5, 2
        );

        book_init(
            db_book_6, 6, "The Hunger Games", "Suzanne Collins",
            "Scholastic Press", "Science fiction,Adventure fiction,Young adult literature",
            timestamp_book_6, 7
        );

        timestamp_t *timestamp_loan_1_st = string_to_timestamp("2024-04-02 00:00:00");
        timestamp_t *timestamp_loan_1_et = string_to_timestamp("2024-04-14 00:00:00");
        timestamp_t *timestamp_loan_2_st = string_to_timestamp("2024-04-05 00:00:00");
        timestamp_t *timestamp_loan_2_et = string_to_timestamp("2024-04-18 00:00:00");
        timestamp_t *timestamp_loan_3_st = string_to_timestamp("2024-04-08 00:00:00");
        timestamp_t *timestamp_loan_3_et = string_to_timestamp("2024-04-12 00:00:00");

        timestamp_t *timestamp_loan_4_st = string_to_timestamp("2024-04-10 00:00:00");
        timestamp_t *timestamp_loan_4_et = string_to_timestamp("2024-04-20 00:00:00");

        timestamp_t *timestamp_loan_5_st = string_to_timestamp("2024-04-11 00:00:00");
        timestamp_t *timestamp_loan_5_et = string_to_timestamp("2024-04-16 00:00:00");

        timestamp_t *timestamp_loan_6_st = string_to_timestamp("2024-04-12 00:00:00");
        timestamp_t *timestamp_loan_6_et = string_to_timestamp("2024-04-18 00:00:00");
